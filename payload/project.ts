  ...
  list: [
    {
      ...
      descriptions: [
        ...
        },
        {
          ...
          weight: 'MEDIUM',
          descriptions: [
            { content: '2년간 진행 되지 않았던 전시 랭킹 배치 신규 버전으로 porting 프로젝트 성공, 서버 이전 작업' },
      ...
      descriptions: [
        {
          ...
          weight: 'MEDIUM',
          descriptions: [
            { content: 'https://dev.onestore.co.kr/wiki/ko/doc/%EA%B0%9C%EB%B0%9C%EB%8F%84%EA%B5%AC/api-v5-sdk-v17/api' },
            { content: '개발사로 하여금 구글플레이 API 환경과 유사한 API를 제공하므로써 원스토어 입점 증대에 기여함' },
          ],
        },
        {
          content: 'Pay-Planet',
    ...
    },
    {
      ...
      descriptions: [
        { content: '휴대폰에 신용카드, 교통카드를 발급, 삭제 사용가능/사용가능 등의 기능을 제공하는 Open API 서버구축 및 상용화' },
        { content: '대표적인 서비스 - 티머니, 캐시비등의 교통 카드, 각 신용카드사의 모바일 카드' },
        { content: 'TDD, 페어프로그래밍 경험' },
        { content: '리펙토링, 모듈 간소화 작업으로 nGrinder로 테스트 결과, 기존 대비 2.7배의 처리 능력 향상' },
      ],
    },
      ...
      descriptions: [
        {
          ...
          weight: 'MEDIUM',
          descriptions: [
            { content: '생활 In 화보서비스 - SKT 무선 포탈 NATE 서비스의 매출에 많은 부분을 기여하는 화보서비스 문자 중계서비스를 안정적으로 개발/운영 함' },
            { content: '2010 월드컵 실시간 문자 중계 서비스 - 계약 문제로 월드컵 오픈 1주일전 개발 시작,' +
    ...
    },
    {
      ...
      where: '필링크',
      descriptions: [
        { content: 'Unix C 개발자가 부족하여 경험도 부족한 신입 사원 이였으나, 훌륭한 상사를 만나 빠른 시간 안에 기존 소스를 습득, 운영/개발을 맡아 상사의 일을 성공적으로 분담' },
        { content: '기존 소스를 바탕으로 게임아이템 판매 게이트웨이를 설계/개발하여 성공적으로 오픈, SKT Tower 게임 개발자 설명회 진행' },
        { content: '타업체가 LG U+ 1000자 문자서비스 순서 바뀜 버그를 수정하지 못하여, LG U+로 파견 업무를 나가, 2주만에 문제 해결하여 조기 진급 포상' },
        { content: '훌륭한 사수를 많나 문서 관리의 중요성, 개발자 로서의 자세 등을 배울 수 있었던 경험 이였습니다.' },
      ],
    },
  ],
};
